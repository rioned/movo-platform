...
private val LightScheme = lightColorScheme(
    ...
    surfaceContainerLow = Color(0xFFF4F8F3),
    surfaceContainer = Color(0xFFEEF3ED),
    surfaceContainerHigh = Color(0xFFE7EFE7),
    surfaceContainerHighest = Color(0xFFDFE9DF),
    surfaceBright = Color.White,
    surfaceDim = Color(0xFFDDE6DD),
...
private val DarkScheme = darkColorScheme(
    ...
    surfaceContainer = Color(0xFF19251E),
    surfaceContainerHigh = Color(0xFF213128),
    surfaceContainerHighest = Color(0xFF2A3D31),
    surfaceBright = Color(0xFF304438),
    surfaceDim = MovoPalette.NightBackground,
