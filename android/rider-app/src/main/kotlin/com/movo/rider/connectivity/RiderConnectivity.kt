package com.movo.rider.connectivity
...
/**
 * Network state for the rider app. Connectivity is shown, never assumed: a rider
 * needs to know whether a status update reached MOVO or is waiting in the queue.
 */
class RiderConnectivity(context: Context) {
